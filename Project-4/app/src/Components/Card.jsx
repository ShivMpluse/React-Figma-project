      ...
      <div className=" container card grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 flex-wrap gap-4 ">
        {
          data?.map(({name, image, text, price}) => (
            <FoodCard key={name} className='border max-h-[150px] rounded-xl flex py-4 px-2 backdrop-blur-[8px] bg-white/5 gap-4'>
              ...
              <div className="food-info">
                ...
                <div className="btn flex justify-end sm:py-3 lg:py-7">
